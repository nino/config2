...
colorize("Normal", { bg = "Black", fg = "White" })
...
colorize('Pmenu', { bg = 'Indigo-900', fg = "Gray-50" })
...
colorize("Statement", { fg = "White", decoration = "none" })
colorize("Comment", { fg = "White", decoration = "bold" })
colorize("Special", { fg = "White" }) -- Delimiters and special characters
colorize("Folded", { fg = "White", bg = "Slate-700" })
