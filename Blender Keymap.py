 ...
 ("Mesh",
  ...
  {"items":
   [("wm.call_menu_pie_drag_only_cpie",
    ...
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_mesh_selection'),
       ...
       ("fallback_op_kwargs", '{"action": "TOGGLE"}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_proportional_edit'),
       ("on_drag", True),
       ("fallback_operator", 'wm.context_toggle'),
       ("fallback_op_kwargs", '{"data_path": "scene.tool_settings.use_proportional_edit"}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_mesh_merge'),
       ("on_drag", False),
       ("fallback_operator", 'wm.tool_set_by_id'),
       ("fallback_op_kwargs", '{"name": "builtin.measure", "cycle": true}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_mesh_flatten'),
       ("on_drag", False),
       ("fallback_operator", 'machin3.symmetrize'),
       ("fallback_op_kwargs", '{"flick": true, "objmode": false}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
    ...
    ("mesh.univ_deselect_linked_pick",
     {"type": 'WHEELDOWNMOUSE', "value": 'PRESS', "shift": True},
     {    "active":False,
      },
     ),
    ("mesh.univ_select_linked_pick",
    ...
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_select_object_name_relation'),
       ("on_drag", False),
       ("fallback_operator", 'machin3.focus'),
       ("fallback_op_kwargs", '{"method": "LOCAL_VIEW", "invert": false}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
    ...
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_proportional_edit'),
       ("on_drag", True),
       ("fallback_operator", 'wm.context_toggle'),
       ("fallback_op_kwargs", '{"data_path": "scene.tool_settings.use_proportional_edit_objects"}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'OBJECT_MT_parenting_pie'),
       ("on_drag", False),
       ("fallback_operator", 'object.parent_set'),
       ("fallback_op_kwargs", '{}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_object_add'),
       ("on_drag", False),
       ("fallback_operator", 'object.select_all'),
       ("fallback_op_kwargs", '{"action": "DESELECT"}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
   ...
   [("wm.call_menu_pie_drag_only_cpie",
    ...
    ("wm.call_menu_pie_drag_only_cpie",
     ...
     {"properties":
      [("name", 'PIE_MT_context_pie'),
       ("on_drag", False),
       ("fallback_operator", 'sculpt.set_pivot_position'),
       ("fallback_op_kwargs", '{"mode": "SURFACE"}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_sculpt_brush_select'),
       ("on_drag", False),
       ("fallback_operator", 'wm.tool_set_by_id'),
       ("fallback_op_kwargs", '{"name": "builtin.move", "cycle": true}'),
       ],
      },
     ),
 ...
 ("UV Editor",
  ...
  {"items":
   [("wm.call_menu_pie_drag_only_cpie",
    ...
    ("uv.univ_show_modified_uv_edges_toggle",
     {"type": 'Z', "value": 'PRESS', "alt": True},
     {    "active":False,
      },
     ),
    ("uv.univ_stretch_uv_toggle",
     {"type": 'Z', "value": 'CLICK'},
     {"properties":
      [("swap", False),
       ],
    ...
    ("uv.univ_rotate",
     {"type": 'FIVE', "value": 'PRESS', "ctrl": True, "alt": True},
     {"properties":
      [("mode", 'BY_CURSOR'),
       ("rot_dir", 'CCW'),
       ],
    ...
    ("wm.call_menu_pie",
     {"type": 'T', "value": 'PRESS'},
     {"properties":
      [("name", 'IMAGE_MT_PIE_univ_transform'),
       ],
    "active":False,
      },
     ),
    ("wm.call_menu_pie",
     {"type": 'Q', "value": 'PRESS'},
     {"properties":
      [("name", 'IMAGE_MT_PIE_univ_favorites_edit'),
       ],
    "active":False,
      },
     ),
    ...
    ("wm.call_menu_pie",
     {"type": 'F1', "value": 'PRESS'},
     {"properties":
      [("name", 'IMAGE_MT_PIE_univ_inspect'),
       ],
    "active":False,
      },
     ),
   ...
   [("wm.call_menu_pie_drag_only",
    ...
    ("wm.call_menu_pie_drag_only",
     ...
     {"properties":
      [("name", 'PIE_MT_file'),
       ("on_drag", True),
       ("fallback_operator", 'wm.call_menu_pie'),
       ("fallback_op_kwargs", '{"name": "MACHIN3_MT_save_pie"}'),
       ],
      },
     ),
    ("wm.call_menu_pie_drag_only",
    ...
    ("wm.univ_toggle_panels_by_cursor",
     {"type": 'T', "value": 'PRESS', "alt": True},
     {    "active":False,
      },
     ),
    ("wm.univ_split_uv_toggle",
     {"type": 'T', "value": 'PRESS', "shift": True},
     {"properties":
      [("mode", 'SPLIT'),
       ],
