...
alias pddraft4='pandoc --pdf-engine=lualatex -V papersize:a4 -V documentclass:scrarticle -V classoption:oneside -V indent -V fontfamily:kpfonts --top-level-division=section  --shift-heading-level-by=0 -V microtypeoptions:protrusion=true,expansion=true,tracking=true,factor=500,stretch=30,shrink=30'
